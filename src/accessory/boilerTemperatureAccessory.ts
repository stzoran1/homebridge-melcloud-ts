 ...
 */
export default class BoilerTemperatureAccessory extends RoomTemperatureAccessory {
  ...
  override async updateDeviceInfo(): Promise<void> {
    ...
    if (deviceInfo.TankWaterTemperature) {
      this.currentTemperature = deviceInfo.TankWaterTemperature
    }
